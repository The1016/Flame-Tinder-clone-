...
export default function ProfilePage({ user }: { user: UserProfile }) {
  ...
  const saveProfile = async () => {
    // TODO: PUT /users/me/profile with { bio, institution, interests }
  };

  return (
    <div className="mx-auto max-w-5xl p-4 md:p-8">
      <div className="grid grid-cols-1 md:grid-cols-[280px,1fr] gap-6 md:gap-10">
        {/* LEFT: hero circular photo */}
        ...
        <section className="space-y-5">
          <div>
            ...
            />
            <p className="mt-1 text-xs text-neutral-400">Name is system-managed and cannot be edited.</p>
          </div>
